...
Once you cloned the repo, you should be able to execute: `rake db:create && rake db:migrate && rake db:seed`

=== Sample Data
There is some small sample data in case you want to play around: `rake db:sample`
